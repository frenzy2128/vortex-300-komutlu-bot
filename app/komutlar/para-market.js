...
.setColor('RANDOM')
.setDescription(`${client.emojis.cache.get(client.emojiler.paraROZET)} Rozeti: **50 ELMAS** (Satın Almak İçin: **${prefix}market rozet**)`)
message.channel.send(e)
    ...
    .setColor('RED')
      ...
      message.channel.send({embed})
        ...
        message.channel.send(`${client.emojis.cache.get(client.emojiler.hayır)} Rozet satın almak için yeterli elmasın bulunuyor. \n Gerekli olan elmas: **${rozetF} ELMAS**.`)
    } else if  (rozetA > rozetF) {
message.channel.send(`${client.emojis.cache.get(client.emojiler.paraROZET)} Rozetini başarıyla aldınız`)
...
db.add(`elmascıklar_${message.member.id}`, -50)
  ...
  db.add(`elmascıklar_${message.member.id}`, -50)
    ...
    if (x === 'kalem') {
      ...
      if (kalem > 0) {
      const embed = new Discord.MessageEmbed()
      .setDescription(`${client.emojis.cache.get(client.emojiler.hayır)} Zaten sende kalem eldiveni bulunuyor fazlasını ne yapacaksın?`)
      .setColor('RED')
      .setTimestamp()
      message.channel.send({embed})
        ...
        message.channel.send(`${client.emojis.cache.get(client.emojiler.hayır)} Kalem satın almak için yeterli paran bulunuyor. \n Gerekli olan para: **250TL**.`)
    } else if  (para > 200) {
message.channel.send(`${client.emojis.cache.get(client.emojiler.evet)} :pencil2: Kalem başarıyla aldınız`)
