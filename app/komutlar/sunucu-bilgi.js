...
let kur = {
	...
	const embed = new Discord.MessageEmbed()
        ...
        .addField(`Emoji [${message.guild.emojis.cache.size}]`, `${prefix}emojiler yazarak sunucudaki bütün emojileri görüntüleyebilirsiniz.`)
		.addField(`Rol [${message.guild.roles.cache.size - 1}]`, `${prefix}roller yazarak sunucudaki bütün rolleri görüntüleyebilirsiniz.`)
