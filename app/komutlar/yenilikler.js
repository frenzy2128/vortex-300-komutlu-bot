...
exports.run = async (client, message, args) => {
  ...
  let y = await client.emojis.cache.get(client.emojiler.yan);
  let prefix = await db.fetch(`prefix_${message.guild.id}`) || client.ayarlar.prefix;

  var ac = client.emojis.cache.get(client.emojiler.evet);
  var ka = client.emojis.cache.get(client.emojiler.hayır);
