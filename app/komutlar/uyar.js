...
exports.run = (client, message, args) => {
  ...
  if (message.mentions.users.cache.size < 1) return message.reply('Uyaracağın kişiyi etiketlemelisin!');
  ...
  //if (!message.guild.member(user).roles.cache.has(muteRole)) return message.reply('Bu kişi zaten susturulmuş!');
